...
def test_service_rows_port_fallback_to_raw():
    ...
    svc_def = ServiceDef(
        name="web", image="nginx", ports=["8080:80", "9090:90"], resolved_ports=[]
    )
...
def test_service_rows_port_single_port():
    ...
    svc_def = ServiceDef(name="web", image="nginx", ports=["8080"], resolved_ports=[])
...
def test_service_rows_port_no_ports():
    ...
    svc_def = ServiceDef(name="web", image="nginx", ports=[], resolved_ports=[])
